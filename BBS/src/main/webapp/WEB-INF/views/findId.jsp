...
<style>
	...
	.findIdDiv{width:450px;height: 400px; padding:25px; border:1px solid;}
	...
	.findPwdDiv{width:450px;height: 400px; padding:25px; border:1px solid; display:none;}
</style>
</head>
<body>
	<div class="findContainer">
		...
		<div class="findIdDiv">
			<span>이름  &nbsp&nbsp&nbsp<input type="text" class="name" required>&nbsp&nbsp <b style="font-size: 5px;">* 숫자로만 입력해주세요.</b></span>
