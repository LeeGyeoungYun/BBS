...
<body>
	<div class="findContainer">
		...
		<div class="findPwdDiv">
			<span>ID &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="text" class="id" required></span>
			<span>Phone  &nbsp<input type="text" class="phone" required>&nbsp&nbsp <b style="font-size: 5px;">* 숫자로만 입력해주세요.</b></span>
